...
class CellPhone:
    ...
    def __init__(self, manufact, model, price): #3 attributes manu mod price
...
#get gives u back value of all attributes
#set methods get the values from user typcially